...
use super::scene_8_controls::Scene8Controls;
use crate::color_ext::ColorExt;
use crate::geometry::{AxisSet, Cuboid, Cylinder, Pyramid, Quat, SignedDistance3d, Sphere, Torus, Vec2, Vec3};
...
pub struct Scene8State {
    camera: Camera,
    #[serde(default)]
    controls: Scene8Controls,
}

crate::stateful_scene!(Scene8, Scene8State);

impl Default for Scene8 {
    fn default() -> Self {
        ...
        Self {
            state: Scene8State {
                camera,
                controls: Scene8Controls::default(),
            },
...
impl Scene8Frame {
    fn sample_scene(&self, point: Vec3, scene_time: f32) -> SdfSample {
        ...
        let (point, _) = point.to_lattice_cell_axes(15.0, AxisSet::XZ);
...
impl SceneFrame for Scene8Frame {
